...
type Transaction struct {
	...
	TransactionDate string  `protobuf:"bytes,5,opt,name=transaction_date,json=transactionDate,proto3" json:"transaction_date,omitempty"` // Use time in Go for better handling
...
// Updated message for handling Razorpay webhook events
type HandleRazorpayWebhookRequest struct {
	...
	Payload *RazorpayWebhookPayload `protobuf:"bytes,2,opt,name=payload,proto3" json:"payload,omitempty"` // Payload containing the transaction details
}
...
func (x *HandleRazorpayWebhookRequest) GetPayload() *RazorpayWebhookPayload {
	if x != nil {
		return x.Payload
	}
	return nil
...
// Updated payload structure for Razorpay webhook
type RazorpayWebhookPayload struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Data    *RazorpayWebhookPayload_Data `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`       // New structure for the webhook data
	Message string                       `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"` // Message field
}

func (x *RazorpayWebhookPayload) Reset() {
	*x = RazorpayWebhookPayload{}
	mi := &file_payment_payment_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RazorpayWebhookPayload) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RazorpayWebhookPayload) ProtoMessage() {}

func (x *RazorpayWebhookPayload) ProtoReflect() protoreflect.Message {
	mi := &file_payment_payment_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RazorpayWebhookPayload.ProtoReflect.Descriptor instead.
func (*RazorpayWebhookPayload) Descriptor() ([]byte, []int) {
	return file_payment_payment_proto_rawDescGZIP(), []int{6}
}

func (x *RazorpayWebhookPayload) GetData() *RazorpayWebhookPayload_Data {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *RazorpayWebhookPayload) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
// Updated message for payment entity details
...
type RazorpayWebhookPayload_Data struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	TransactionId   int32   `protobuf:"varint,1,opt,name=transaction_id,json=transactionId,proto3" json:"transaction_id,omitempty"`         // Transaction ID
	BookingId       int32   `protobuf:"varint,2,opt,name=booking_id,json=bookingId,proto3" json:"booking_id,omitempty"`                     // Booking ID
	UserId          int32   `protobuf:"varint,3,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`                              // User ID
	PaymentMethodId int32   `protobuf:"varint,4,opt,name=payment_method_id,json=paymentMethodId,proto3" json:"payment_method_id,omitempty"` // Payment method ID
	TransactionDate string  `protobuf:"bytes,5,opt,name=transaction_date,json=transactionDate,proto3" json:"transaction_date,omitempty"`    // Transaction date as string
	Amount          float64 `protobuf:"fixed64,6,opt,name=amount,proto3" json:"amount,omitempty"`                                           // Transaction amount
	OrderId         string  `protobuf:"bytes,7,opt,name=order_id,json=orderId,proto3" json:"order_id,omitempty"`                            // Order ID
	Status          string  `protobuf:"bytes,8,opt,name=status,proto3" json:"status,omitempty"`                                             // Payment status
}

func (x *RazorpayWebhookPayload_Data) Reset() {
	*x = RazorpayWebhookPayload_Data{}
	mi := &file_payment_payment_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RazorpayWebhookPayload_Data) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RazorpayWebhookPayload_Data) ProtoMessage() {}

func (x *RazorpayWebhookPayload_Data) ProtoReflect() protoreflect.Message {
	mi := &file_payment_payment_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RazorpayWebhookPayload_Data.ProtoReflect.Descriptor instead.
func (*RazorpayWebhookPayload_Data) Descriptor() ([]byte, []int) {
	return file_payment_payment_proto_rawDescGZIP(), []int{6, 0}
}

func (x *RazorpayWebhookPayload_Data) GetTransactionId() int32 {
	if x != nil {
		return x.TransactionId
	}
	return 0
...
func (x *RazorpayWebhookPayload_Data) GetBookingId() int32 {
	if x != nil {
		return x.BookingId
	}
	return 0
...
func (x *RazorpayWebhookPayload_Data) GetUserId() int32 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *RazorpayWebhookPayload_Data) GetPaymentMethodId() int32 {
	if x != nil {
		return x.PaymentMethodId
	}
	return 0
...
func (x *RazorpayWebhookPayload_Data) GetTransactionDate() string {
	if x != nil {
		return x.TransactionDate
	}
	return ""
...
func (x *RazorpayWebhookPayload_Data) GetAmount() float64 {
	if x != nil {
		return x.Amount
	}
	return 0
...
func (x *RazorpayWebhookPayload_Data) GetOrderId() string {
	if x != nil {
		return x.OrderId
	}
	return ""
...
func (x *RazorpayWebhookPayload_Data) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
var file_payment_payment_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x61, 0x74, 0x65, 0x22, 0x6f,
	...
	,
	...
	0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x2a, 0x0a, 0x11, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e,
	...
	0x6e, 0x5f, 0x64, 0x61, 0x74, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x74, 0x72,
	...
	0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xca, 0x02, 0x0a, 0x0d, 0x50, 0x61, 0x79,
	0x6d, 0x65, 0x6e, 0x74, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	...
	0x64, 0x12, 0x24, 0x0a, 0x0d, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x61, 0x6c, 0x18, 0x06, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0d, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x12, 0x16, 0x0a, 0x06, 0x6d, 0x65, 0x74, 0x68, 0x6f,
	...
	0x66, 0x65, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x74, 0x61, 0x78, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x01,
	0x52, 0x03, 0x74, 0x61, 0x78, 0x22, 0x51, 0x0a, 0x1d, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x52,
	0x61, 0x7a, 0x6f, 0x72, 0x70, 0x61, 0x79, 0x57, 0x65, 0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x32, 0xb0, 0x02, 0x0a, 0x0e, 0x50, 0x61, 0x79,
	...
	0x6e, 0x73, 0x65, 0x12, 0x66, 0x0a, 0x15, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x52, 0x61, 0x7a,
	0x6f, 0x72, 0x70, 0x61, 0x79, 0x57, 0x65, 0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x12, 0x25, 0x2e, 0x70,
	0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x52, 0x61, 0x7a,
	0x6f, 0x72, 0x70, 0x61, 0x79, 0x57, 0x65, 0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x26, 0x2e, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x48, 0x61,
	0x6e, 0x64, 0x6c, 0x65, 0x52, 0x61, 0x7a, 0x6f, 0x72, 0x70, 0x61, 0x79, 0x57, 0x65, 0x62, 0x68,
	0x6f, 0x6f, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0b, 0x5a, 0x09, 0x2e,
...
var file_payment_payment_proto_goTypes = []any{
	...
	(*RazorpayWebhookPayload)(nil),        // 6: payment.RazorpayWebhookPayload
	(*PaymentEntity)(nil),                 // 7: payment.PaymentEntity
	(*HandleRazorpayWebhookResponse)(nil), // 8: payment.HandleRazorpayWebhookResponse
	(*RazorpayWebhookPayload_Data)(nil),   // 9: payment.RazorpayWebhookPayload.Data
}
var file_payment_payment_proto_depIdxs = []int32{
	0, // 0: payment.ProcessPaymentResponse.transaction:type_name -> payment.Transaction
	6, // 1: payment.HandleRazorpayWebhookRequest.payload:type_name -> payment.RazorpayWebhookPayload
	9, // 2: payment.RazorpayWebhookPayload.data:type_name -> payment.RazorpayWebhookPayload.Data
