...
const (
	...
	TheatreService_GetAvailableSeatsByScreenIDAndShowTimeID_FullMethodName              = "/moviebooking.TheatreService/GetAvailableSeatsByScreenIDAndShowTimeID"
...
type TheatreServiceClient interface {
	...
	GetAvailableSeatsByScreenIDAndShowTimeID(ctx context.Context, in *GetAvailableSeatsByScreenIDAndShowTimeIDRequest, opts ...grpc.CallOption) (*GetAvailableSeatsByScreenIDAndShowTimeIDResponse, error)
...
func (c *theatreServiceClient) GetAvailableSeatsByScreenIDAndShowTimeID(ctx context.Context, in *GetAvailableSeatsByScreenIDAndShowTimeIDRequest, opts ...grpc.CallOption) (*GetAvailableSeatsByScreenIDAndShowTimeIDResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetAvailableSeatsByScreenIDAndShowTimeIDResponse)
	err := c.cc.Invoke(ctx, TheatreService_GetAvailableSeatsByScreenIDAndShowTimeID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TheatreServiceServer interface {
	...
	GetAvailableSeatsByScreenIDAndShowTimeID(context.Context, *GetAvailableSeatsByScreenIDAndShowTimeIDRequest) (*GetAvailableSeatsByScreenIDAndShowTimeIDResponse, error)
...
func (UnimplementedTheatreServiceServer) GetAvailableSeatsByScreenIDAndShowTimeID(context.Context, *GetAvailableSeatsByScreenIDAndShowTimeIDRequest) (*GetAvailableSeatsByScreenIDAndShowTimeIDResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAvailableSeatsByScreenIDAndShowTimeID not implemented")
}
...
func _TheatreService_GetAvailableSeatsByScreenIDAndShowTimeID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAvailableSeatsByScreenIDAndShowTimeIDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TheatreServiceServer).GetAvailableSeatsByScreenIDAndShowTimeID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TheatreService_GetAvailableSeatsByScreenIDAndShowTimeID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TheatreServiceServer).GetAvailableSeatsByScreenIDAndShowTimeID(ctx, req.(*GetAvailableSeatsByScreenIDAndShowTimeIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TheatreService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetAvailableSeatsByScreenIDAndShowTimeID",
			Handler:    _TheatreService_GetAvailableSeatsByScreenIDAndShowTimeID_Handler,
		},
		{
