...
func (x *CreateChatRequest) GetSuperAdminId() string {
	if x != nil {
...
func (x *EndChatResponse) GetChatId() string {
	if x != nil {
		return x.ChatId
	}
	return ""
...
func (x *StreamMessagesResponse) GetMessageId() string {
	if x != nil {
		return x.MessageId
	}
	return ""
...
var file_notification_notification_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x19, 0x0a, 0x08, 0x61, 0x64, 0x6d,
	...
	0x6d, 0x69, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x73, 0x75,
