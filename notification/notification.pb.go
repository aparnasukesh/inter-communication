...
func (x *AddMessageRequest) GetChatId() int32 {
	if x != nil {
		return x.ChatId
	}
	return 0
...
func (x *EndChatRequest) GetChatId() int32 {
	if x != nil {
		return x.ChatId
	}
	return 0
...
var file_notification_notification_proto_rawDesc = []byte{
	...
	0x05, 0x52, 0x06, 0x63, 0x68, 0x61, 0x74, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x74, 0x61,
